...
namespace Timesplinter\P2P\Example;
...
use Timesplinter\P2P\DelegateMessageHandler;
...
$nodeEventHandler = new NodeEventHandler($messageHandler, $connectionPool);
...
$messageHandler
    ->addMessageHandler(
        ...
        new VersionMessageHandler($nodeId, NodeEventHandler::NODE_VERSION, $connectionPool)
    )
    ->addMessageHandler(
        Message::TYPE_VERSION_ACKNOWLEDGED,
        new VersionAcknowledgedMessageHandler()
    )
    ->addMessageHandler(
        Message::TYPE_LIST_KNOWN_NODES,
